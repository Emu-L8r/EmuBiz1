...
class OfflineCustomersRepository @Inject constructor(private val customerDao: CustomerDao) : CustomerRepository {
    ...
    override suspend fun insertCustomer(customer: Customer): Long = customerDao.insert(customer)
