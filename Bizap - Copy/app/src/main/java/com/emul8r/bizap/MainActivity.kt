...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            val config by themeRepository.themeConfig.collectAsState(initial = ThemeConfig())
    ...
    Scaffold(
        ...
        floatingActionButton = {
            when {
                ...
                currentDestination?.hasRoute<Screen.Invoices>() == true -> {
                    FloatingActionButton(onClick = { navController.navigate(Screen.CreateInvoice) }) {
        ...
        NavHost(
            ...
            composable<Screen.Invoices> { 
                InvoiceList(onInvoiceClick = { invoiceId ->
