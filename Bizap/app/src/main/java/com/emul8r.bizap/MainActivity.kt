...
import com.emul8r.bizap.ui.components.BrandedHeaderBackground
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Ensure the Status Bar is transparent to allow our imagery to show behind it
        enableEdgeToEdge()
...
fun MainScreen(onSwitchGui: () -> Unit = {}) {
    ...
    Scaffold(
        ...
        // Removed safeDrawing padding from Scaffold so the TopAppBar can bleed into Status Bar
        topBar = {
            val title = when {
