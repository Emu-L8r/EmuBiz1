...
class RevenueRepositoryV2Test : BaseUnitTest() {
    ...
    fun `observeRevenueMetrics combines 5 flows correctly`() = runTest {
        ...
        every { daoV2.observeMTDRevenue(businessId, any()) } returns flowOf(125000L)
        every { daoV2.observeYTDRevenue(businessId, any()) } returns flowOf(500000L)
        every { daoV2.observeWeeklyRevenue(businessId, any()) } returns flowOf(100000L)
    ...
    fun `observeRevenueMetrics returns zero values when no data`() = runTest {
        every { daoV2.observeMTDRevenue(businessId, any()) } returns flowOf(0L)
        every { daoV2.observeYTDRevenue(businessId, any()) } returns flowOf(0L)
        every { daoV2.observeWeeklyRevenue(businessId, any()) } returns flowOf(0L)
